...
function Chapter() {
  ...
  const chapters = [
    { id: 1, title: "Chapter 1", locked: false },
    { id: 2, title: "Chapter 2", locked: false },
    { id: 3, title: "Chapter 3", locked: false },
    { id: 4, title: "Chapter 4", locked: true },
    { id: 5, title: "Chapter 5", locked: true },
    { id: 6, title: "Chapter 6", locked: true },
    { id: 7, title: "Chapter 7", locked: true },
    { id: 8, title: "Chapter 8", locked: true },
    { id: 9, title: "Chapter 9", locked: true },
    { id: 10, title: "Chapter 10", locked: true },
  ];

  const chapterText = {
    1: `
I checked my phone for the sixth time in twenty minutes. Six missed calls from Ryan, but not a single text explaining where he was.

Around me, the Metro Denver Prenatal Clinic buzzed with life—expectant mothers nestled against their partners' shoulders.

I sat alone, my wedding ring suddenly heavy on my finger.

My hand instinctively moved to my rounded belly, feeling the slight flutter that had become familiar these past few weeks.
...
The nurse gave me a sympathetic smile as she led me toward the ultrasound room.

I kept checking my phone, hoping to see his name appear on the screen.

But the silence only grew heavier.
`,
    3: `
The scan room was cold and too bright.

Emily adjusted the monitor while I lay back, trying to steady my breathing.

When the baby's heartbeat filled the room, my eyes burned with tears.

Ryan was supposed to hear this too.
`,
    4: `
I watched my phone light up with notification after notification as my post spread like wildfire through the Denver Moms Connect group.

Each vibration felt like a small victory, each comment a brick in the wall I was building between my old life and whatever came next.
`,
    5: `
Chapter 5 preview text.
`,
    6: `
Chapter 6 preview text.
`,
    7: `
Chapter 7 preview text.
`,
    8: `
Chapter 8 preview text.
`,
    9: `
Chapter 9 preview text.
`,
    10: `
The morning air carried a crisp bite as I knelt in the memorial garden, my knees pressing into the soft earth.

Autumn had painted the city in amber and gold, transforming Denver's skyline into a watercolor backdrop against the clear blue sky.

In my hands, I held the letter one final time.

Some endings do not come with closure. Some truths arrive too late to save anything at all.

But as the wind moved through the trees, I realized I no longer needed his apology to begin again.
`,
  };
  ...
  const text = chapterText[chapterNumber] || chapterText[1];
  ...
  const isLockedChapter =
    chapterNumber >= 4 && !unlockedChapters.includes(chapterNumber);
  ...
  return (
    <div style={styles.page}>
      <div style={styles.topBar}>
        ...
        <span style={styles.topTitle}>Chapter {chapterNumber}</span>
      </div>

      <div style={styles.content}>
        <h1 style={styles.chapterTitle}>Chapter {chapterNumber}</h1>
          ...
          <div style={styles.drawer} onClick={(e) => e.stopPropagation()}>
              ...
              <div style={styles.drawerBookInfo}>
                ...
                <div>
                  ...
                  <div style={styles.drawerMeta}>
                    <span style={styles.drawerCount}>10 Chapter</span>
            ...
            <div style={styles.chapterList}>
              {chapters.map((chapter) => {
                const isCurrent = chapter.id === chapterNumber;
                const locked =
                  chapter.id >= 4 && !unlockedChapters.includes(chapter.id);
              ...
              <PayPalButtons
                ...
                onApprove={async (data) => {
                  try {
                    ...
                    addCoinsToWallet(
                      result.addCoins || selectedPackData.coins
                    );
